...
/* services: */
service CommonMessagePostService {
...
service CommonMessageFetchService {
  map<CommonMessageTypes,i32> availableMessages(),
  void fetchHeartbeat(1: list<Heartbeat> msg),
  void fetchSysStatus(1: list<SysStatus> msg),
  void fetchSystemTime(1: list<SystemTime> msg),
  void fetchPing(1: list<Ping> msg),
  void fetchChangeOperatorControl(1: list<ChangeOperatorControl> msg),
  void fetchChangeOperatorControlAck(1: list<ChangeOperatorControlAck> msg),
  void fetchAuthKey(1: list<AuthKey> msg),
  void fetchSetMode(1: list<SetMode> msg),
  void fetchParamRequestRead(1: list<ParamRequestRead> msg),
  void fetchParamRequestList(1: list<ParamRequestList> msg),
  void fetchParamValue(1: list<ParamValue> msg),
  void fetchParamSet(1: list<ParamSet> msg),
  void fetchGpsRawInt(1: list<GpsRawInt> msg),
  void fetchGpsStatus(1: list<GpsStatus> msg),
  void fetchScaledImu(1: list<ScaledImu> msg),
  void fetchRawImu(1: list<RawImu> msg),
  void fetchRawPressure(1: list<RawPressure> msg),
  void fetchScaledPressure(1: list<ScaledPressure> msg),
  void fetchAttitude(1: list<Attitude> msg),
  void fetchAttitudeQuaternion(1: list<AttitudeQuaternion> msg),
  void fetchLocalPositionNed(1: list<LocalPositionNed> msg),
  void fetchGlobalPositionInt(1: list<GlobalPositionInt> msg),
  void fetchRcChannelsScaled(1: list<RcChannelsScaled> msg),
  void fetchRcChannelsRaw(1: list<RcChannelsRaw> msg),
  void fetchServoOutputRaw(1: list<ServoOutputRaw> msg),
  void fetchMissionRequestPartialList(1: list<MissionRequestPartialList> msg),
  void fetchMissionWritePartialList(1: list<MissionWritePartialList> msg),
  void fetchMissionItem(1: list<MissionItem> msg),
  void fetchMissionRequest(1: list<MissionRequest> msg),
  void fetchMissionSetCurrent(1: list<MissionSetCurrent> msg),
  void fetchMissionCurrent(1: list<MissionCurrent> msg),
  void fetchMissionRequestList(1: list<MissionRequestList> msg),
  void fetchMissionCount(1: list<MissionCount> msg),
  void fetchMissionClearAll(1: list<MissionClearAll> msg),
  void fetchMissionItemReached(1: list<MissionItemReached> msg),
  void fetchMissionAck(1: list<MissionAck> msg),
  void fetchSetGpsGlobalOrigin(1: list<SetGpsGlobalOrigin> msg),
  void fetchGpsGlobalOrigin(1: list<GpsGlobalOrigin> msg),
  void fetchSetLocalPositionSetpoint(1: list<SetLocalPositionSetpoint> msg),
  void fetchLocalPositionSetpoint(1: list<LocalPositionSetpoint> msg),
  void fetchGlobalPositionSetpointInt(1: list<GlobalPositionSetpointInt> msg),
  void fetchSetGlobalPositionSetpointInt(1: list<SetGlobalPositionSetpointInt> msg),
  void fetchSafetySetAllowedArea(1: list<SafetySetAllowedArea> msg),
  void fetchSafetyAllowedArea(1: list<SafetyAllowedArea> msg),
  void fetchSetRollPitchYawThrust(1: list<SetRollPitchYawThrust> msg),
  void fetchSetRollPitchYawSpeedThrust(1: list<SetRollPitchYawSpeedThrust> msg),
  void fetchRollPitchYawThrustSetpoint(1: list<RollPitchYawThrustSetpoint> msg),
  void fetchRollPitchYawSpeedThrustSetpoint(1: list<RollPitchYawSpeedThrustSetpoint> msg),
  void fetchSetQuadMotorsSetpoint(1: list<SetQuadMotorsSetpoint> msg),
  void fetchSetQuadSwarmRollPitchYawThrust(1: list<SetQuadSwarmRollPitchYawThrust> msg),
  void fetchNavControllerOutput(1: list<NavControllerOutput> msg),
  void fetchSetQuadSwarmLedRollPitchYawThrust(1: list<SetQuadSwarmLedRollPitchYawThrust> msg),
  void fetchStateCorrection(1: list<StateCorrection> msg),
  void fetchRequestDataStream(1: list<RequestDataStream> msg),
  void fetchDataStream(1: list<DataStream> msg),
  void fetchManualControl(1: list<ManualControl> msg),
  void fetchRcChannelsOverride(1: list<RcChannelsOverride> msg),
  void fetchVfrHud(1: list<VfrHud> msg),
  void fetchCommandLong(1: list<CommandLong> msg),
  void fetchCommandAck(1: list<CommandAck> msg),
  void fetchRollPitchYawRatesThrustSetpoint(1: list<RollPitchYawRatesThrustSetpoint> msg),
  void fetchManualSetpoint(1: list<ManualSetpoint> msg),
  void fetchLocalPositionNedSystemGlobalOffset(1: list<LocalPositionNedSystemGlobalOffset> msg),
  void fetchHilState(1: list<HilState> msg),
  void fetchHilControls(1: list<HilControls> msg),
  void fetchHilRcInputsRaw(1: list<HilRcInputsRaw> msg),
  void fetchOpticalFlow(1: list<OpticalFlow> msg),
  void fetchGlobalVisionPositionEstimate(1: list<GlobalVisionPositionEstimate> msg),
  void fetchVisionPositionEstimate(1: list<VisionPositionEstimate> msg),
  void fetchVisionSpeedEstimate(1: list<VisionSpeedEstimate> msg),
  void fetchViconPositionEstimate(1: list<ViconPositionEstimate> msg),
  void fetchHighresImu(1: list<HighresImu> msg),
  void fetchOmnidirectionalFlow(1: list<OmnidirectionalFlow> msg),
  void fetchFileTransferStart(1: list<FileTransferStart> msg),
  void fetchFileTransferDirList(1: list<FileTransferDirList> msg),
  void fetchFileTransferRes(1: list<FileTransferRes> msg),
  void fetchBatteryStatus(1: list<BatteryStatus> msg),
  void fetchSetpoint8dof(1: list<Setpoint8dof> msg),
  void fetchSetpoint6dof(1: list<Setpoint6dof> msg),
  void fetchMemoryVect(1: list<MemoryVect> msg),
  void fetchDebugVect(1: list<DebugVect> msg),
  void fetchNamedValueFloat(1: list<NamedValueFloat> msg),
  void fetchNamedValueInt(1: list<NamedValueInt> msg),
  void fetchStatustext(1: list<Statustext> msg),
  void fetchDebug(1: list<Debug> msg)
}
