...
class CommonMessagePostServiceHandler : virtual public CommonMessagePostServiceIf {
 public:
  CommonMessagePostServiceHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<CommonMessagePostServiceHandler> handler(new CommonMessagePostServiceHandler());
  shared_ptr<TProcessor> processor(new CommonMessagePostServiceProcessor(handler));
