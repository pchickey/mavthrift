...
class ArdupilotmegaMessagePostServiceHandler : virtual public ArdupilotmegaMessagePostServiceIf {
 public:
  ArdupilotmegaMessagePostServiceHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<ArdupilotmegaMessagePostServiceHandler> handler(new ArdupilotmegaMessagePostServiceHandler());
  shared_ptr<TProcessor> processor(new ArdupilotmegaMessagePostServiceProcessor(handler));
